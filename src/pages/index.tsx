...
const HomePage = () => {
  ...
  const handleNextPage = () => {
    ...
    omdbApi
      ...
      .then((response) => {
        setPage(page + 1)
        const { Response: status, Search: records } = response.data
      ...
      <div className="bg-secondary py-5">
        <div className="container">
          ...
          <div>
            ...
            >
              <input
                className="form-control form-control-lg mb-3 mb-sm-0 me-sm-3"
                type="text"
                {...register('searchTerm')}
        ...
        {isLoading ? (
          ...
          <InfiniteScroll
            ...
            endMessage={
              <div className="w-100 d-flex align-items-center justify-content-center py-5">
                <span className="fs-5">
                  Todos os filmes para a busca foram exibidos!
                </span>
              </div>
            }
          >
          ...
          <div className="d-flex align-items-center">
            {movies ? (
              ...
              <span className="fs-4 text-gray-400">
                Comece digitando um termo no campo de busca acima
              </span>
            )}
          </div>
        )}
